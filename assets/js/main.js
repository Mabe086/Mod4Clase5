...
$(document).ready(function(){
    ...
    $(document).on("click","#btn-registrar", function(event) {
        ...
        if(color == "") {
            return alert("Por favor ingresar el color del electrodoméstico")
        }
    ...
    function listarElectrodomesticos() {
        $("#listado tbody").html("")
        $("#total-registros").text(listado.lenght)
        //$("#total-registros").html(`<span class="text-danger">${listado.lenght}</span>`)
        let contador = 0
